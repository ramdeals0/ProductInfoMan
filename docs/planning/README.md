...
|---|----------|-------------|
| 00 | [Project Foundation](./00-project-foundation.md) | Vision, objectives, stakeholders, workflow, phases |
| 01 | [Requirements](./01-requirements.md) | Functional and non-functional requirements |
| 02 | [Epics & Phases](./02-epics-and-phases.md) | 15 epics with acceptance criteria and backlog order |
| 03 | [Domain Model](./03-domain-model.md) | Entity relationship outline and inheritance model |
| 04 | [Discovery Workshop](./04-discovery-workshop.md) | Pre-development questionnaire |
